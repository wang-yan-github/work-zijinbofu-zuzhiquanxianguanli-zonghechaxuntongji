...
Template.bofumx.rendered = function(){
    ...
    $(document).ready(function(){
        ...
        // 日期下拉
        selectYear('cxtj_ksnd');
        selectYear('cxtj_jsnd');
...
//            pageLength: 25, // 分页长度
    ...
    // 设置年份的选择
    function selectYear(myYear) {
        var myDate= new Date();
        var startYear=myDate.getFullYear()-10;//起始年份
        var endYear=myDate.getFullYear()+0;//结束年份
